// Seed the datastore with realistic demo data for the prototype.
...
const users = [
  { id: "usr_admin", name: "Dr. Kittiphat", email: "clinicdoctorkittiphat@gmail.com", username: "admin", password: "admin123", role: "owner" },
  { id: "usr_nurse", name: "พยาบาลสมหญิง", email: "nurse@drkittiphat.clinic", username: "nurse", password: "nurse123", role: "staff" },
];

save({ users, patients, appointments, services, invoices, inventory });
console.log("✓ Seeded demo data → data/db.json");
